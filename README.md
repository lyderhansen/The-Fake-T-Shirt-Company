...
```
The-Fake-T-Shirt-Company/              <-- Git root
...
cp -r TheFakeTshirtCompany/TA-FAKE-TSHRT $SPLUNK_HOME/etc/apps/
...
| **disk_filling** | Ops | 5 days | Server disk gradually filling up |
...
|----------|-------------|
| [TA-FAKE-TSHRT/README.md](TheFakeTshirtCompany/TA-FAKE-TSHRT/README.md) | App overview, installation, usage |
| [TA-FAKE-TSHRT/bin/README.md](TheFakeTshirtCompany/TA-FAKE-TSHRT/bin/README.md) | Generator engine, scenarios, shared utilities |
| [TA-FAKE-TSHRT/default/README.md](TheFakeTshirtCompany/TA-FAKE-TSHRT/default/README.md) | Splunk configuration, sourcetypes, CIM mappings |
| [docs/scenarios/README.md](TheFakeTshirtCompany/docs/scenarios/README.md) | Scenario overview, timeline, key personnel |
| [docs/datasource_docs/README.md](TheFakeTshirtCompany/docs/datasource_docs/README.md) | Data source documentation index |
